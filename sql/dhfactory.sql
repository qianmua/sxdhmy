/*
 ...
 Source Schema         : dehong

 Target Server Type    : MySQL
 Target Server Version : 50529
 File Encoding         : 65001

 Date: 20/09/2020 15:17:51
*/

create database sxhdmy_service;
...
CREATE TABLE `factory_c`  (
  `FACTORY_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '厂家id',
  `FULL_NAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '厂家全称',
  `FACTORY_NAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名称缩写',
  `CONTACTOR` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系人',
  ...
  `CNOTE` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '说明',
  `CTYPE` int(11) NULL DEFAULT NULL COMMENT '类型  SYS_CODE_B 0103',
  `STATE` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '状态  1正常2停止',
...
-- ----------------------------
INSERT INTO `factory_c` VALUES (1, '陕西康达彩印厂', '康达', '袁喜', '029-84528015', '123456789', '111', '彩印厂', 11, '1', '1', 123, '111', 'admin', '2020-09-08 00:28:00');
INSERT INTO `factory_c` VALUES (2, '陕西虹彩彩印厂', '虹彩', '王说', '029-84528215', '123456789', '111', '彩印厂', 11, '1', '1', 123, '111', 'admin', '2020-09-12 00:28:00');
INSERT INTO `factory_c` VALUES (3, '陕西飞鸣纸箱厂', '飞鸣', '张琳', '029-84528415', '123456789', '111', '纸箱厂', 11, '1', '1', 123, '111', 'admin', '2020-09-13 00:28:00');
...
CREATE TABLE `users`  (
  ...
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户账户',
...
-- Records of users
-- ----------------------------
/*INSERT INTO `users` VALUES (1, '薛薛酱', 'admin', '123456');
INSERT INTO `users` VALUES (2, '说', 'admin', '123456');
INSERT INTO `users` VALUES (3, '小韩', 'admin', '123456');
INSERT INTO `users` VALUES (4, '像', 'admin', '123456');
INSERT INTO `users` VALUES (5, '张忆菲', 'zyf', 'e10adc3949ba59abbe56e057f20f883e');
*/
